...
class Vemaybay {
protected: 
	string tenchuyen; // ten chuyen bay 
	Date ngaybay; // thoi gian bay 
	int giave; // gia tri ve
public: 
	Vemaybay() {
		this->tenchuyen = "";
		this->giave = 0; 
	...
	{
		cin.ignore();
		cout << "Nhap Ten Chuyen: "; getline(cin, this->tenchuyen);
		cout << "Nhap Ngay Bay: "; this->ngaybay.input();
	...
	void output()
	{
		...
		cout << "Ngay Bay: "; this->ngaybay.output();
...
public:
    ...
    void input()
    {
        ...
        cout << "Nhap Gioi Tinh: "; getline(cin, this->gioitinh);
